...
export const ChoicePage = React.forwardRef<
  HTMLDivElement,
  ChoicePageProps
>(({ disabled }, ref) => {
  ...
  const handleEvaluateInterview = () => {
    router.push('/evaluate-interview');
  };
    ...
    >
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          <h1 className="text-fg0 text-2xl font-bold">
            Plataforma de Entrevista com IA
          </h1>
          <p className="text-fg1 max-w-prose leading-6">
        ...
        {session && status === 'authenticated' ? (
          ...
          <div className="space-y-4">
            <Button 
              ...
              disabled
            >
              {status === 'loading' ? 'Loading...' : 'Sign in to start'}
            </Button>
...
ChoicePage.displayName = 'ChoicePage';